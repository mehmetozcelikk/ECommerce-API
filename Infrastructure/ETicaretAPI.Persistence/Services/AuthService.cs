...
public class AuthService : IAuthService
{
    ...
    public AuthService(IHttpClientFactory httpClientFactory,
        ...
        UserManager<ECommerce.Domain.Entities.Identity.AppUser> userManager,
    ...
    public async Task<Token> FacebookLoginAsync(string authToken, int accessTokenLifeTime)
    {
        ...
        if (validation?.Data.IsValid != null)
        {
            ...
            ECommerce.Domain.Entities.Identity.AppUser user = await _userManager.FindByLoginAsync(info.LoginProvider, info.ProviderKey);
    ...
    {
        ECommerce.Domain.Entities.Identity.AppUser user = await _userManager.FindByNameAsync(usernameOrEmail);
        if (user == null)
